...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 24, 2019 at 05:24 PM
...
CREATE TABLE if not exists `restaurant` (
  ...
  `average_cost_for_two` varchar(255) DEFAULT NULL,
  `currency` varchar(255) DEFAULT NULL,
  `has_table_booking` varchar(255) DEFAULT NULL,
  `has_online_delivery` varchar(255) DEFAULT NULL,
  `aggregate_rating` varchar(255) DEFAULT NULL,
...
INSERT INTO `restaurant` (`restaurant_id`, `restaurant_name`, `cuisines`, `average_cost_for_two`, `currency`, `has_table_booking`, `has_online_delivery`, `aggregate_rating`, `rating_color`, `rating_text`, `votes`) VALUES
...
(6600060, 'Sandubas Caf?', 'Brazilian, Cafe', '30', 'Brazilian Real(R$)', 'No', 'No', '0', 'White', 'Not rated', '2'),
...
(6600970, 'Pizza ?? Bessa', 'Pizza', '50', 'Brazilian Real(R$)', 'No', 'No', '3.2', 'Orange', 'Average', '11'),
(6601005, 'Caf? Daniel Briand', 'Cafe', '30', 'Brazilian Real(R$)', 'No', 'No', '3.8', 'Yellow', 'Good', '9'),
(6601158, 'Manzu??', 'Seafood', '240', 'Brazilian Real(R$)', 'No', 'No', '3.2', 'Orange', 'Average', '6'),
...
(6601862, 'Tayp??', 'Peruvian, Latin American', '100', 'Brazilian Real(R$)', 'No', 'No', '3.6', 'Yellow', 'Good', '5'),
...
(6701419, 'Divino Fog?o', 'Brazilian, Mineira', '65', 'Brazilian Real(R$)', 'No', 'No', '0', 'White', 'Not rated', '2'),
...
(6705858, 'Terra?_o It??lia', 'Italian', '400', 'Brazilian Real(R$)', 'No', 'No', '4.4', 'Green', 'Very Good', '37'),
...
(6709580, 'Esquina Mocot?_', 'Brazilian, North Eastern', '100', 'Brazilian Real(R$)', 'No', 'No', '4.4', 'Green', 'Very Good', '22'),
...
(7300483, 'Zaz?? Bistr?? Tropical', 'Brazilian', '170', 'Brazilian Real(R$)', 'No', 'No', '4.6', 'Dark Green', 'Excellent', '21'),
...
(7300955, 'Braseiro da G??vea', 'Brazilian, Bar Food', '100', 'Brazilian Real(R$)', 'No', 'No', '4.9', 'Dark Green', 'Excellent', '40'),
(7301064, 'Fil? de Ouro', 'Brazilian', '90', 'Brazilian Real(R$)', 'No', 'No', '4.3', 'Green', 'Very Good', '14'),
...
(7302898, 'Apraz?_vel', 'Brazilian', '300', 'Brazilian Real(R$)', 'No', 'No', '4.7', 'Dark Green', 'Excellent', '44'),
